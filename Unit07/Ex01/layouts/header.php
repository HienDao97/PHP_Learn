            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="products.php"><i class="fa fa-dashboard fa-fw"></i> Quan ly san pham</a>
                        </li>
                        <li>
                            <a href="customers.php"><i class="fa fa-dashboard fa-fw"></i> Quan ly khach hang</a>
                        </li>
                        <li>
                            <a href="employees.php"><i class="fa fa-dashboard fa-fw"></i> Quan ly nhan vien</a>
                        </li>
