...
require_once('connection.php');
    ...
    if($status==true){
        setcookie('msg','Them nhan vien thanh cong',time()+5);
    }else{
        setcookie('msg','Them nhan vien khong thanh cong',time()+5);
    }
    ...
    <div class="container">
        ...
        <form action="" method="POST" role="form" id="form-register">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="" name="MaNV" placeholder="" required>
            </div>
            <div class="form-group">
                <label for="">Ten nhan vien</label>
                <input type="text" class="form-control" id="" name="TenNV" placeholder="" required>
            </div>
            <div class="form-group">
                <label for="">SDT</label>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="" name= "MatKhau" placeholder="" required>
            </div>
