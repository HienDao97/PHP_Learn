            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="Manager_user.php"><i class="fa fa-dashboard fa-fw"></i> Quan ly nguoi dung</a>
                        </li>
                        <li>
                            <a href="Manager_content.php"><i class="fa fa-dashboard fa-fw"></i> Quan ly bai viet</a>
                        </li>
                        <li>
                            <a href="Manager_tags.php"><i class="fa fa-dashboard fa-fw"></i> Quan ly tags</a>
                        </li>
