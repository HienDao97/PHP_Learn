		...
		<div id="content">
			...
			<div class="table-responsive">
				...
				<table class="shop_table beta-shopping-cart-table" cellspacing="0">
					...
					$tien=0;
					foreach( $cart as $row){
						$tien+=$row['SLmua']*$row['DonGia'];
						?>
						<tr class="cart_item">
							<td class="product-name">
								<div class="media">
									<img class="pull-left" src="<?=$row['image']?>" alt="" width="255px" height="255px">
									<div class="media-body">
										<p class="font-large table-title"><?=$row['TenSP']?></p>
							...
							<td class="product-price">
								<span class="amount"><?=number_format($row['DonGia'])?></span>
							</td>

							
							<td class="product-quantity">
								<a class="btn btn-primary" href="?mod=home&act=addtocart2&MaSP=<?= $row['MaSP']?>">+</a>
                                            <?= $row['SLmua']?>
                                            <a class="btn btn-primary" href="?mod=home&act=xoa1&MaSP=<?= $row['MaSP']?>">-</a>
							</td>
			...
			echo "</pre>";
								 ?> -->
								<span class="amount"><?= number_format($row["DonGia"]*$row['SLmua'])?></span>
							</td>

							<td class="product-remove">
								<a href="?mod=home&act=Xoa&MaSP=<?= $row['MaSP']?>" class="remove" title="Remove this item"><i class="fa fa-trash-o"></i></a>
							</td>
						</tr>
						<?php }?>
						<!-- <tr class="cart_item">
							<td class="product-name">
								<div class="media">
									<img class="pull-left" src="../public/source/image/product/Originals/tra-sua-panda.jpg" alt="">
									<div class="media-body">
					...
					<tfoot>
						<tr>
							<td colspan="6" class="actions">
								...
								<a  class="beta-btn primary" name="update_cart" href="?mod=home&act=huybill">Delete Bill <i class="fa fa-chevron-right"></i></a> 
								<a  class="beta-btn primary" name="proceed" href="?mod=home&act=pay">Proceed to Checkout <i class="fa fa-chevron-right"></i></a>
							</td>
						</tr>
					</tfoot>
				</table>
			...
			<div class="cart-collaterals">
				...
				<div class="cart-totals pull-right">
					...
					<div class="cart-totals-row"><span>Cart Subtotal:</span> <span style="color: red;"><?=number_format($tien)?></span>đ</div>
					<div class="cart-totals-row"><span>Shipping:</span> <span>Free Shipping</span></div>
					<div class="cart-totals-row"><span>Order Total:</span> <span style="color: red;"><?=number_format($tien)?></span>đ</span></div>
				</div>
