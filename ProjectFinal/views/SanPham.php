					...
					<div class="row">
						...
						<div class="col-sm-8">
							<div class="single-item-body">
								<p class="single-item-title" style="color: blue; font-size: 20px;"><?=$product['TenSP']?></p>
								<p class="single-item-price" style="padding-top: 30px;"> Đơn giá:
							...
							<div class="single-item-desc">
								<p><span style="font-weight: bold; ">Mô tả:</span><?=$product['GhiChu']?></p>
							</div>
							<div class="space20">&nbsp;</div>
							...
							<div class="single-item-options">
								...
								<a class="add-to-cart" href="?mod=home&act=addtocart2&MaSP=<?= $product['MaSP']?>"><i class="fa fa-shopping-cart"></i></a>
								<div class="clearfix"></div>
							</div>
						</div>
					</div>
					...
					<div class="widget">
						...
						<div class="widget-body">
							<div class="beta-sales beta-lists">
								...
								<div class="media beta-sales-item">
									<a class="pull-left" href="product.html"><img src="../public/source/image/product/Originals/tra-sua-panda.jpg" alt=""></a>
									<div class="media-body">
										Sample Woman Top
										<span class="beta-sales-price">$34.55</span>
									</div>
